...
@section('title', 'Tambah Master RO')
...
<div class="container-fluid py-4">
    <div class="row mb-4 align-items-center">
        <div class="col-md-6">
            <h4 class="mb-0 fw-bold text-gray-800">
                <i class="fas fa-plus text-primary me-2"></i> Tambah Rincian Output
            </h4>
        </div>
    ...
    <div class="card border-0 shadow-sm rounded-4">
        <div class="card-body p-4 p-md-5">
            <form action="{{ route('tabel-ro.store') }}" method="POST">
                @csrf
                ...
                <div class="row g-4 mb-5">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" name="ro" class="form-control" value="{{ old('ro') }}" placeholder="Masukkan nama Rincian Output" required>
                    </div>
                </div>
                ...
                <div class="row g-4 mb-5">
                    <div class="col-md-6">
                        ...
                        <input type="number" step="0.01" name="realisasi_volume_ro" class="form-control" value="{{ old('realisasi_volume_ro', 0) }}">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label fw-semibold">Progres RO (%)</label>
                        <div class="input-group">
                            <input type="number" step="0.01" name="progres_ro" class="form-control" value="{{ old('progres_ro', 0) }}">
                ...
                <div class="row g-4">
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" step="0.01" name="pagu_awal" class="form-control" value="{{ old('pagu_awal', 0) }}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            <span class="input-group-text">Rp</span>
                            <input type="number" step="0.01" name="pagu_revisi" class="form-control" value="{{ old('pagu_revisi', 0) }}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            <span class="input-group-text">Rp</span>
                            <input type="number" step="0.01" name="pagu_realisasi" class="form-control" value="{{ old('pagu_realisasi', 0) }}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            <span class="input-group-text">Rp</span>
                            <input type="number" step="0.01" name="pagu_sisa" class="form-control" value="{{ old('pagu_sisa', 0) }}">
                        </div>
                        <small class="text-muted d-block mt-1">Isi manual sisa pagu dari perhitungan di atas.</small>
                    </div>
                </div>

                <div class="mt-5 text-end">
                    <button type="submit" class="btn btn-primary rounded-pill px-5 shadow-sm">
                        <i class="fas fa-save me-1"></i> Simpan Data RO
                    </button>
                </div>
            </form>
        </div>
